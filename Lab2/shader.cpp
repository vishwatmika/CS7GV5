...
GLuint Shader::CompileShaders()
{
	...
	AddShader(shaderProgramID, "diffuse.vs", GL_VERTEX_SHADER);
	AddShader(shaderProgramID, "diffuse.ps", GL_FRAGMENT_SHADER);
...
GLuint Shader::skyboxShader()
{
	...
	// Create two shader objects, one for the vertex, and one for the fragment shader
	AddShader(shaderProgramID, "skybox_vs.txt", GL_VERTEX_SHADER);
	AddShader(shaderProgramID, "skybox_fs.txt", GL_FRAGMENT_SHADER);
